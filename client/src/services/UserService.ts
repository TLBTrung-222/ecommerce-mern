import { IPayload, SignInForm, SignUpForm, UserData, ApiResponse, UpdateForm } from '~/types'
import { jwtDecode } from 'jwt-decode'

const userEndpoint = `${import.meta.env.VITE_API_URL}/users`

export const logInUser = async (signInData: SignInForm): Promise<ApiResponse> => {
...
export const signUpUser = async (signUpData: SignUpForm): Promise<ApiResponse> => {
...
export const decodeAccessToken = (accessToken: string): IPayload | undefined => {
    try {
...
export const updateUserProfile = async (data: UpdateForm) => {
